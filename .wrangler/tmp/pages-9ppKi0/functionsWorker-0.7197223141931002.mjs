...
// ../.wrangler/tmp/bundle-v4V7px/strip-cf-connecting-ip-header.js
...
async function onRequest(context) {
  ...
  const relativePath = Array.isArray(pathParts) ? pathParts.map(encodeURIComponent).join("/") : encodeURIComponent(pathParts);
  ...
  if (request.method === "PUT" && reqUrl.searchParams.get("restype") !== "directory") {
    ...
    if (length > 0) {
      ...
      const newHeaders3 = new Headers(rangeRes.headers);
      newHeaders3.set("Access-Control-Allow-Origin", "*");
    ...
    const newHeaders2 = new Headers(createRes.headers);
...
// ../.wrangler/tmp/pages-9ppKi0/functionsRoutes-0.007337142926811424.mjs
var routes = [
  {
...
// ../.wrangler/tmp/bundle-v4V7px/middleware-insertion-facade.js
...
// ../.wrangler/tmp/bundle-v4V7px/middleware-loader.entry.ts
...
//# sourceMappingURL=functionsWorker-0.7197223141931002.mjs.map
