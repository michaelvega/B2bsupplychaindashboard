...
import {
  ...
  Building2, Gauge, BarChart3, Database
} from 'lucide-react';
...
export function Forecasting() {
  ...
  return (
    <div className="h-full flex flex-col overflow-hidden bg-grid-pattern bg-gray-50/80">
      ...
      {/* Tab Bar */}
      <div className="relative z-10 px-8 py-3 border-b border-gray-200/60 bg-white/50 backdrop-blur-sm flex items-center gap-2">
        <button
                ...
                {showAddFactory && (
                  <div className="px-5 py-3 border-b border-gray-100 bg-gray-50/50 flex items-center gap-3">
                    <input
                      ...
                      className="flex-1 px-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 bg-white"
                      onKeyDown={e => e.key === 'Enter' && handleAddFactory()}
                    />
                    <select
                      value={newFactoryType}
                      onChange={e => setNewFactoryType(e.target.value)}
                      className="px-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 bg-white"
                    >
                    ...
                    <button
                      ...
                      className="px-3 py-1.5 text-xs font-semibold bg-gray-800 text-white rounded-lg hover:bg-gray-900 disabled:opacity-50 transition-colors"
                    >
                      Add
                    </button>
              ...
              {showAddFactor && (
                <div className="px-5 py-3 border-b border-gray-100 bg-gray-50/50 flex items-center gap-3 flex-wrap">
                  <input
                    ...
                    className="flex-1 min-w-[140px] px-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 focus:border-gray-400 bg-white"
                  ...
                  <input
                    ...
                    className="w-28 px-3 py-1.5 text-xs border border-gray-200 rounded-lg focus:outline-none focus:ring-1 focus:ring-gray-400 bg-white"
                  />
                  <select
